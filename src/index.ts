...
<body class="bg-gray-50 min-h-screen">
  ...
  <script>
    ...
    createApp({ setup() {
      ...
      const posts = [
        {id:16,title:'🌍 Crypto Market Overview: $2.56T Cap, BTC Dominance at 60.15%',excerpt:'Global crypto market cap at $2.56T with $76.17B 24h volume. DeFi volume at $8.52B (11.18%).',content:'<p><strong>Market Snapshot — May 19, 2026:</strong></p><pre style="background:#f5f5f5;padding:12px;border-radius:8px;font-size:13px;line-height:1.7">Global Market Cap: $2.56T
24h Volume:       $76.17B
BTC Dominance:    60.15%
DeFi Volume:      $8.52B (11.18%)</pre><p>The total crypto market volume over the last 24 hours is $76.17B, a 24.72% decrease. DeFi volume is $8.52B, 11.18% of total. Stablecoin volume is $78.23B, 102.71% of total market volume.</p><p>Bitcoin dominance currently at 60.15%, a decrease of 0.07% over the day. Market sentiment shifting as AI tokens and DeFi gain momentum.</p><p><strong>Indonesian:</strong> Kapitalisasi pasar kripto global $2.56T dengan volume 24 jam $76.17B. Dominasi Bitcoin 60.15%. Volume DeFi $8.52B.</p><p><em>Data powered by CoinMarketCap via UpRock Crawl.</em></p>',category:'Market Data',date:'May 19, 2026',readTime:4,image:'https://picsum.photos/seed/marketcap26/800/400',isNew:true},
        ...
        {id:15,title:'🥞 PancakeSwap (CAKE) Holds $1.39 as DeFi Volumes Surge on BSC',excerpt:'CAKE trading at $1.39 with $455M market cap. Cake/WBNB pair leads with $340K daily volume and $14.6M liquidity.',content:'<p><strong>CAKE/USD — May 19, 2026:</strong> PancakeSwap token (CAKE) is trading at $1.39, maintaining stability across BSC, Base, Arbitrum, and Solana chains.</p><p>💰 <strong>Price:</strong> $1.39 (konsisten di semua chain)<br>📊 <strong>Market Cap:</strong> $455M<br>🌐 <strong>Chains:</strong> BSC, Solana, Base, Arbitrum, Aptos, zkSync</p><p><strong>Top Pairs PancakeSwap BSC:</strong></p><pre style="background:#f5f5f5;padding:12px;border-radius:8px;font-size:13px;line-height:1.7">Cake/WBNB  | $340K vol | 2,413 txns | Liq: $14.6M (v2)
Cake/USDT  | $40K vol  | 2,468 txns | Liq: $5.3M (v3)
Cake/ETH   | $625K vol | 2,340 txns | Liq: $814K (v3)
Cake/BTCB  | $10K vol  | 406 txns   | Liq: $504K (v3)</pre><p><strong>Multi-chain Presence:</strong> CAKE is listed on PancakeSwap (BSC, Base, Arbitrum, Aptos, zkSync), Meteora (Solana), Sushiswap (Arbitrum), and Uniswap (BSC). 24-hour change: -0.44%.</p><p><strong>Indonesian:</strong> PancakeSwap (CAKE) stabil di $1.39 dengan kapitalisasi pasar $455 juta. Pair Cake/WBNB memimpin dengan volume $340K harian. Tersedia di 7 chain berbeda.</p><p><em>Data powered by DexScreener via UpRock Crawl.</em></p>',category:'DeFi',date:'May 19, 2026',readTime:5,image:'https://picsum.photos/seed/pancakeswap26/800/400',isNew:true},
