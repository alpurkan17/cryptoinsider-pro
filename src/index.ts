...
<body class="bg-gray-50 min-h-screen">
  ...
  <script>
    ...
    createApp({ setup() {
      ...
      const posts = [
        {id:16,title:'🌍 Crypto Market Overview: $2.56T Cap, BTC Dominance at 60.15%',excerpt:'Global crypto market cap at $2.56T with $76.17B 24h volume. DeFi volume at $8.52B (11.18%).',content:'<div class="data-grid"><div class="item"><div class="label">🌐 Market Cap</div><div class="value">$2.56T</div></div><div class="item"><div class="label">📊 24h Volume</div><div class="value">$76.17B</div></div><div class="item"><div class="label">🟠 BTC Dominance</div><div class="value">60.15%</div></div><div class="item"><div class="label">🔷 DeFi Volume</div><div class="value">$8.52B</div></div></div><div class="data-card"><p style="margin:0 0 8px;color:#4b5563;font-size:14px;line-height:1.7">The total crypto market volume over the last 24 hours is <strong>$76.17B</strong>, a 24.72% decrease. DeFi volume represents <strong>11.18%</strong> of total. Stablecoin volume is <strong>$78.23B</strong>, 102.71% of total market volume.</p><p style="margin:0;color:#4b5563;font-size:14px;line-height:1.7">Bitcoin dominance at <strong>60.15%</strong>, down 0.07% over the day. Market sentiment shifting as AI tokens and DeFi gain momentum.</p></div><p style="color:#6b7280;font-size:13px"><span class="stat-badge">CoinMarketCap</span> Data powered by UpRock Crawl</p><p><strong>Indonesian:</strong> Kapitalisasi pasar kripto global <strong>$2.56T</strong> dengan volume 24 jam <strong>$76.17B</strong>. Dominasi Bitcoin <strong>60.15%</strong>. Volume DeFi <strong>$8.52B</strong>.</p>',category:'Market Data',date:'May 19, 2026',readTime:4,image:'https://picsum.photos/seed/marketcap26/800/400',isNew:true},
        ...
        {id:15,title:'🥞 PancakeSwap (CAKE) Holds $1.39 as DeFi Volumes Surge on BSC',excerpt:'CAKE trading at $1.39 with $455M market cap. Cake/WBNB pair leads with $340K daily volume and $14.6M liquidity.',content:'<div class="data-grid"><div class="item"><div class="label">💰 Price</div><div class="value">$1.39</div><div style="font-size:11px;color:#6b7280">konsisten semua chain</div></div><div class="item"><div class="label">📊 Market Cap</div><div class="value">$455M</div></div><div class="item"><div class="label">📉 24h Change</div><div class="value" style="color:#dc2626">-0.44%</div></div><div class="item"><div class="label">🔗 Chains</div><div style="margin-top:4px"><span class="chain-tag">BSC</span><span class="chain-tag">Solana</span><span class="chain-tag">Base</span><span class="chain-tag">Arbitrum</span><span class="chain-tag">Aptos</span><span class="chain-tag">zkSync</span></div></div></div><div class="data-card"><div class="label" style="margin-bottom:8px">📈 Top Pairs PancakeSwap BSC</div><table class="pair-table"><thead><tr><th>Pair</th><th>Volume 24h</th><th>Transactions</th><th>Liquidity</th><th>Version</th></tr></thead><tbody><tr><td><strong>Cake/WBNB</strong></td><td>$340K</td><td>2,413</td><td>$14.6M</td><td><span class="stat-badge">v2</span></td></tr><tr><td><strong>Cake/USDT</strong></td><td>$40K</td><td>2,468</td><td>$5.3M</td><td><span class="stat-badge">v3</span></td></tr><tr><td><strong>Cake/ETH</strong></td><td>$625K</td><td>2,340</td><td>$814K</td><td><span class="stat-badge">v3</span></td></tr><tr><td><strong>Cake/BTCB</strong></td><td>$10K</td><td>406</td><td>$504K</td><td><span class="stat-badge">v3</span></td></tr></tbody></table></div><p style="color:#4b5563;font-size:14px;line-height:1.7"><strong>Multi-chain Presence:</strong> CAKE listed on PancakeSwap (BSC, Base, Arbitrum, Aptos, zkSync), Meteora (Solana), Sushiswap, Uniswap.</p><p style="color:#6b7280;font-size:13px"><span class="stat-badge">DexScreener</span> Data powered by UpRock Crawl</p><p><strong>Indonesian:</strong> PancakeSwap (CAKE) stabil di <strong>$1.39</strong> dengan kapitalisasi pasar <strong>$455 juta</strong>. Pair Cake/WBNB memimpin dengan volume <strong>$340K</strong> harian. Tersedia di 7 chain berbeda.</p>',category:'DeFi',date:'May 19, 2026',readTime:5,image:'https://picsum.photos/seed/pancakeswap26/800/400',isNew:true},
